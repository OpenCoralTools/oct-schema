# Contributing to oct-schema

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
oct-schema. These guidelines are not strict rules.
...
The oct-schema team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the oct-schema technical leads
...
[issues]: https://github.com/OpenCoralTools/oct-schema/issues/
[pulls]: https://github.com/OpenCoralTools/oct-schema/pulls/
