...
# Generation date: 2025-12-11T12:46:58
# Schema: oct-schema
#
...
class NamedThing(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = OCT_SCHEMA.NamedThing
...
class PersonCollection(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = OCT_SCHEMA["PersonCollection"]
    class_class_curie: ClassVar[str] = "oct_schema:PersonCollection"
    class_name: ClassVar[str] = "PersonCollection"
    class_model_uri: ClassVar[URIRef] = OCT_SCHEMA.PersonCollection
...
slots.primary_email = Slot(
    ...
    model_uri=OCT_SCHEMA.primary_email,
    domain=None,
    range=Optional[str],
)
...
slots.birth_date = Slot(
    ...
    model_uri=OCT_SCHEMA.birth_date,
    domain=None,
    range=Optional[Union[str, XSDDate]],
)

slots.age_in_years = Slot(
    uri=OCT_SCHEMA.age_in_years,
    name="age_in_years",
    curie=OCT_SCHEMA.curie("age_in_years"),
    model_uri=OCT_SCHEMA.age_in_years,
    domain=None,
    range=Optional[int],
)

slots.vital_status = Slot(
    uri=OCT_SCHEMA.vital_status,
    name="vital_status",
    curie=OCT_SCHEMA.curie("vital_status"),
    model_uri=OCT_SCHEMA.vital_status,
    domain=None,
    range=Optional[Union[str, "PersonStatus"]],
)

slots.personCollection__entries = Slot(
    uri=OCT_SCHEMA.entries,
    name="personCollection__entries",
    curie=OCT_SCHEMA.curie("entries"),
    model_uri=OCT_SCHEMA.personCollection__entries,
    domain=None,
    range=Optional[
        Union[
            dict[Union[str, PersonId], Union[dict, Person]], list[Union[dict, Person]]
...
slots.Person_primary_email = Slot(
    ...
    curie=SCHEMA.curie("email"),
    model_uri=OCT_SCHEMA.Person_primary_email,
    domain=Person,
    range=Optional[str],
